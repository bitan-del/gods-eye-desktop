---
name: bump-version
description: Use when bumping the Gods Eye version: update package.json, run checks, branch, commit, push, create PR, wait for merge, tag release.
---

# Bump Version

Automate the Gods Eye version bump workflow: update version → quality checks → branch → commit → push → PR → tag.
