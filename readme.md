...
<p align="center">
  <strong>English</strong> | <a href="./docs/readme/readme_ch.md">简体中文</a> | <a href="./docs/readme/readme_tw.md">繁體中文</a> | <a href="./docs/readme/readme_jp.md">日本語</a> | <a href="./docs/readme/readme_ko.md">한국어</a> | <a href="./docs/readme/readme_es.md">Español</a> | <a href="./docs/readme/readme_pt.md">Português</a> | <a href="./docs/readme/readme_tr.md">Türkçe</a> | <a href="https://www.gods-eye.org" target="_blank">Official Website</a>
</p>

<p align="center">
  <strong>💬 Community:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="./resources/wx-6.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Gods Eye" target="_blank">Twitter</a>
</p>
...
[🤔 Why Choose Gods Eye?](#-why-choose-godseye-over-claude-cowork) ·
...
**Gods Eye is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **Gods Eye (Cowork)**                                                                          |
| :------------------------------ | :-------------------------- | :------------------------------------------------------------------------------------------- |
...
Gods Eye ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **Gods Eye works the moment you install it**.
...
If you already use Claude Code, Codex, or Qwen Code, Gods Eye auto-detects them and lets you Cowork with all of them — alongside the built-in agent.
...
Other AI apps give you a chatbox with your API key. **Gods Eye gives you a full Cowork agent.**
...
Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. Gods Eye supports **20+ AI platforms** including cloud services and local deployments.
...
Gods Eye also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
Gods Eye includes **12 professional assistants** with predefined capabilities, extendable through custom skills:
...
_Your 24/7 AI assistant — access Gods Eye from any device, anywhere._
...
> **Setup:** Gods Eye Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/bitan-del/gods-eye/wiki/Remote-Internet-Access-Guide-Chinese)
...
> [Image generation model configuration guide](https://github.com/bitan-del/gods-eye/wiki/Gods Eye-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose Gods Eye Over Claude Cowork?
...
Gods Eye is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, Gods Eye is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | Gods Eye                                           |
| :------------ | :------------ | :----------------------------------------------- |
...
A: <strong>No.</strong> Gods Eye has a built-in AI agent that works immediately after installation. Just sign in with Google or enter any API key. If you also have CLI tools like Claude Code or Gemini CLI installed, Gods Eye will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with Gods Eye?</strong></summary>
A: Gods Eye is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: Gods Eye is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>
...
> **Made a video about Gods Eye?** [Let us know on X](https://x.com/Gods Eye) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/bitan-del/gods-eye/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/bitan-del/gods-eye/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/bitan-del/gods-eye/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/bitan-del/gods-eye/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/bitan-del/gods-eye/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/bitan-del/gods-eye/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/bitan-del/gods-eye/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/bitan-del/gods-eye/wiki/Gods Eye-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/bitan-del/gods-eye/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/bitan-del/gods-eye/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/bitan-del/gods-eye/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/bitan-del/gods-eye/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/bitan-del/gods-eye/issues) — bugs and feature requests
- [Release Updates](https://github.com/bitan-del/gods-eye/releases) — get the latest version
...
[Report Bug](https://github.com/bitan-del/gods-eye/issues) · [Request Feature](https://github.com/bitan-del/gods-eye/issues)
