...
for f in Gods Eye-1.0.0-win-x64.exe Gods Eye-1.0.0-win-arm64.exe Gods Eye-1.0.0-mac-x64.dmg Gods Eye-1.0.0-mac-arm64.dmg Gods Eye-1.0.0.deb Gods Eye-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
