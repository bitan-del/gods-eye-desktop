...
│  │   用户同意后，调用 godseye_create_team 工具。"                        │     │
│  └────────────────────────────────────────────────────────────────────┘     │
│                                                                             │
...
└─────────────────┬───────────────────────────────────────────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│                    AGENT 调用 MCP Tool: godseye_create_team                     │
│                                                                             │
│  Tool Input:                                                                │
│  {                                                                          │
│    "summary": "构建完整电商网站，包含：                                      │
...
└─────────────────┬───────────────────────────────────────────────────────────┘
                  ...
                  ▼
┌═════════════════════════════════════════════════════════════════════════════┐
║                  MCP SERVER: godseye_navigate handler                          ║
║                                                                             ║
...
```
 User          Renderer        Solo Agent       MCP Server       Main Process       Team Lead
  ...
  │               │                │                │                 │                  │
  │               │                │──⑦ call ──────▶│                 │                  │
  │◀── "正在跳转" │               │ godseye_navigate  │── deepLink ────▶│                  │
  │               │                │                │   emit          │                  │
  │               │◀───────────────│────────────────│── IPC emit ────│                  │
  │               │                │                │                 │                  │
  │               │─⑧ navigate ──┐│                │                 │                  │
...
- **路由白名单**：`godseye_navigate` 只允许跳转到已知路由（`/team/:id`, `/conversation/:id`）
