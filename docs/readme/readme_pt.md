<p align="center">
  <img src="../../resources/godseye-banner-1.png" alt="Gods Eye - Cowork with AI Agents" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/bitan-del/gods-eye?style=flat-square&color=32CD32" alt="Version">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <strong>Português</strong> | <a href="./readme_tr.md">Türkçe</a> | <a href="https://www.gods-eye.org" target="_blank">Site oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidade:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-6.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Gods Eye" target="_blank">Twitter</a>
</p>
...
[🤔 Por que escolher Gods Eye?](#-por-que-escolher-godseye-sobre-claude-cowork) ·
...
**Gods Eye é mais que um cliente de chat.** É uma plataforma Cowork onde os AI Agents trabalham com você no seu computador — lendo arquivos, escrevendo código, navegando na web e automatizando tarefas. Você pode ver tudo que o Agent faz e sempre está no controle.

|                                              | Clientes de chat AI tradicionais | **Gods Eye (Cowork)**                                                                                      |
| :------------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------- |
...
<p align="center">
  <img src="../../resources/offica-ai BANNER-function.png" alt="Gods Eye Cowork Platform" width="800">
</p>
...
Gods Eye vem com um motor de Agent AI completo. Diferente de ferramentas que exigem instalar CLI Agents separadamente, **Gods Eye funciona no momento em que você o instala**.
...
- **Gerou, já visualiza** — abra `.ppt` / `.pptx` no Gods Eye sem trocar de aplicativo
...
Se você já usa Claude Code, Codex ou Qwen Code, Gods Eye os detecta automaticamente e permite fazer Cowork com todos eles — junto com o Agent integrado.
...
Outros apps de AI te dão uma caixa de chat com sua chave API. **Gods Eye te dá um Cowork Agent completo.**
...
As mesmas capacidades do Agent — leitura/escrita de arquivos, busca na web, geração de imagens, uso de ferramentas — independentemente do modelo que o alimenta. Gods Eye suporta **20+ plataformas AI** incluindo serviços em nuvem e implantações locais.
...
Gods Eye também suporta o serviço de gateway [NewAPI](https://github.com/QuantumNous/new-api) — um hub unificado de modelos AI que agrega e distribui vários LLMs. Alterne flexivelmente entre diferentes modelos na mesma interface para atender a vários requisitos de tarefas.
...
Gods Eye inclui **12 assistentes profissionais** com capacidades predefinidas, extensíveis através de habilidades personalizadas:
...
_Seu assistente AI 24/7 — acesse Gods Eye de qualquer dispositivo, em qualquer lugar._
...
> **Configuração:** Gods Eye Settings → WebUI Settings → Channel, configure o Bot Token.
...
> [Tutorial de acesso remoto à Internet](https://github.com/bitan-del/gods-eye/wiki/Remote-Internet-Access-Guide-Chinese)
...
<p align="center">
  <img src="../../resources/godseye sort file 2.gif" alt="Smart File Management" width="800">
</p>
...
> [Guia de configuração do modelo de geração de imagens](https://github.com/bitan-del/gods-eye/wiki/Gods Eye-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Por que escolher Gods Eye sobre Claude Cowork?
...
Gods Eye é um **Desktop Multi-AI Agent gratuito e de código aberto**. Comparado ao Claude Cowork que só roda no macOS e está bloqueado ao Claude, Gods Eye é sua versão aprimorada de modelo completo e multiplataforma.

| Dimensão           | Claude Cowork  | Gods Eye                                              |
| :----------------- | :------------- | :-------------------------------------------------- |
...
R: <strong>Não.</strong> Gods Eye tem um AI Agent integrado que funciona imediatamente após a instalação. Basta fazer login com Google ou inserir qualquer chave API. Se você também tiver ferramentas CLI como Claude Code ou Gemini CLI instaladas, Gods Eye as detectará e integrará automaticamente para ainda mais capacidades.
</details>

<details>
<summary><strong>P: O que posso fazer com Gods Eye?</strong></summary>
R: Gods Eye é seu <strong>espaço de trabalho Cowork privado</strong>. O Agent integrado pode organizar pastas em lote, processar dados do Excel, gerar documentos, buscar na web e gerar imagens. Com o Modo Multi-Agent, você também pode aproveitar Claude Code, Codex e outros Agents CLI poderosos através da mesma interface.
</details>

<details>
<summary><strong>P: É gratuito?</strong></summary>
R: Gods Eye é completamente gratuito e de código aberto. Você pode fazer login com Google para usar Gemini gratuitamente, ou usar chaves API de qualquer provedor que preferir.
</details>
...
## Veja como as pessoas usam Gods Eye
...
> **Fez um vídeo sobre Gods Eye?** [Avise-nos no X](https://x.com/Gods Eye) e vamos destacá-lo aqui!
...
- [📖 Guia de instalação completo](https://github.com/bitan-del/gods-eye/wiki/Getting-Started) — Passos detalhados do download à configuração
- [⚙️ Guia de configuração LLM](https://github.com/bitan-del/gods-eye/wiki/LLM-Configuration) — Configuração de modelos AI multiplataforma
- [🤖 Configuração do modo Multi-Agent](https://github.com/bitan-del/gods-eye/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuração de ferramentas MCP](https://github.com/bitan-del/gods-eye/wiki/MCP-Configuration-Guide) — Configuração do servidor Model Context Protocol
- [🌐 Guia de configuração WebUI](https://github.com/bitan-del/gods-eye/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuração e instalação do WebUI

**🎯 Casos de uso**

- [📁 Gerenciamento de arquivos](https://github.com/bitan-del/gods-eye/wiki/file-management) — Organização inteligente de arquivos
- [📊 Processamento de Excel](https://github.com/bitan-del/gods-eye/wiki/excel-processing) — Processamento de dados alimentado por AI
- [🎨 Geração de imagens](https://github.com/bitan-del/gods-eye/wiki/Gods Eye-Image-Generation-Tool-Model-Configuration-Guide) — Criação de imagens AI
- [📚 Mais casos de uso](https://github.com/bitan-del/gods-eye/wiki/Use-Cases-Overview)

**❓ Suporte e ajuda**

- [❓ FAQ](https://github.com/bitan-del/gods-eye/wiki/FAQ) — Perguntas e solução de problemas
- [🔧 Tutoriais de configuração e uso](https://github.com/bitan-del/gods-eye/wiki/Configuration-Guides) — Documentação de configuração completa
...
<p align="center">
  <a href="https://x.com/Gods Eye" target="_blank">
    <img src="../../resources/contactus-x.png" alt="Contact Us on X" width="600">
  </a>
</p>

- [GitHub Discussions](https://github.com/bitan-del/gods-eye/discussions) — compartilhe ideias e troque dicas
- [Reportar problemas](https://github.com/bitan-del/gods-eye/issues) — bugs e solicitações de recursos
- [Atualizações de lançamento](https://github.com/bitan-del/gods-eye/releases) — obtenha a última versão
...
<p align="center">
  <a href="https://github.com/bitan-del/gods-eye/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=bitan-del/gods-eye&max=50" alt="Contributors" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.star-history.com/#iOfficeAI/godseye&Date" target="_blank">
    <img src="https://api.star-history.com/svg?repos=iOfficeAI/godseye&type=Date" alt="Star History" width="600">
  </a>
</p>
...
[Reportar bug](https://github.com/bitan-del/gods-eye/issues) · [Solicitar recurso](https://github.com/bitan-del/gods-eye/issues)
