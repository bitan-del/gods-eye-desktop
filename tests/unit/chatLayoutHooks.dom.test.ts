...
vi.mock('@/renderer/utils/workspace/workspaceEvents', () => ({
  WORKSPACE_TOGGLE_EVENT: 'godseye-workspace-toggle',
  WORKSPACE_STATE_EVENT: 'godseye-workspace-state',
  WORKSPACE_HAS_FILES_EVENT: 'godseye-workspace-has-files',
...
describe('useWorkspaceCollapse', () => {
  const STORAGE_KEY = 'godseye_workspace_panel_collapsed';
