...
preflight:
    ...
    $failed = $false; \
    Write-Host "=========================================="; \
    Write-Host "  Gods Eye Build Preflight Check"; \
    Write-Host "=========================================="; \
    Write-Host ""; \
...
info:
    Write-Host "Gods Eye Build Environment"; \
    Write-Host "========================"; \
...
build-win: preflight
    ...
    Get-Process -Name "Gods Eye","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue; \
