...
const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <div className='flex items-center gap-8px'>
      <GodsEyeSelect ref={selectRef} className='w-160px' value={i18n.language} onChange={handleLanguageChange}>
        <GodsEyeSelect.Option value='zh-CN'>简体中文</GodsEyeSelect.Option>
        <GodsEyeSelect.Option value='zh-TW'>繁體中文</GodsEyeSelect.Option>
        <GodsEyeSelect.Option value='ja-JP'>日本語</GodsEyeSelect.Option>
