...
const AboutModalContent: React.FC = () => {
  ...
  const checkUpdate = () => {
    ...
    window.dispatchEvent(new CustomEvent('godseye-open-update-modal', { detail: { source: 'about' } }));
  };

  const linkItems: LinkItem[] = [
    {
      title: t('settings.helpDocumentation'),
      url: 'https://github.com/bitan-del/gods-eye-desktop/wiki',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/bitan-del/gods-eye-desktop/releases',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.feedback'),
      url: 'https://github.com/bitan-del/gods-eye-desktop/issues',
      icon: <Right theme='outline' size='16' />,
    },
    {
    ...
    },
    {
      ...
      url: 'https://github.com/bitan-del/gods-eye-desktop',
      icon: <Right theme='outline' size='16' />,
    },
  ];
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/bitan-del/gods-eye-desktop').catch((error) =>
