            ...
            <Form form={form} layout='vertical' className='space-y-16px' onValuesChange={handleValuesChange}>
              ...
              <div className='!mt-32px'>
                <Form.Item label={t('settings.logDir')}>
                  <div className='godseye-dir-input h-[32px] flex items-center rounded-8px border border-solid border-transparent pl-14px bg-[var(--fill-0)] '>
          ...
          <div className='px-[12px] md:px-[32px] py-16px bg-2 rd-16px space-y-12px'>
            ...
            >
              <Button
                ...
                size='small'
                onClick={() => {
                  void ipcBridge.cliInstaller.openSetupInTerminal.invoke();
                  Message.success('Terminal opened with setup wizard');
                }}
              >
