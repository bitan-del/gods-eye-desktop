...
import { Brain, Computer, Earth, Gemini, Info, LinkCloud, Puzzle, Toolkit } from '@icon-park/react';
...
import BrainModalContent from './contents/BrainModalContent';
 ...
 */
export type BuiltinSettingTab = 'gemini' | 'model' | 'agent' | 'tools' | 'webui' | 'brain' | 'system' | 'about';
