...
const BrainSettings = React.lazy(() => import('@renderer/pages/settings/BrainSettings'));
...
const JarvisPage = React.lazy(() => import('@renderer/pages/jarvis'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/brain' element={withRouteFallback(BrainSettings)} />
          {/* Legacy: /settings/pet → Brain (Desktop Pet was removed) */}
          <Route path='/settings/pet' element={<Navigate to='/settings/brain' replace />} />
          ...
          <Route path='/jarvis' element={withRouteFallback(JarvisPage)} />
        </Route>
