...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/bitan-del/gods-eye/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/bitan-del/gods-eye/discussions/1325';
