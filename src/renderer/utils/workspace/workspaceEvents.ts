export const WORKSPACE_TOGGLE_EVENT = 'godseye-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'godseye-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'godseye-workspace-has-files';
