...
export const ASSISTANT_PRESETS: AssistantPreset[] = [
  ...
  },
  {
    ...
    defaultEnabledSkills: ['openclaw-setup', 'godseye-webui-setup'],
    nameI18n: {
      'en-US': 'Gods Eye Setup Expert',
      'zh-CN': 'Gods Eye 部署专家',
      'ru-RU': 'Эксперт по настройке Gods Eye',
    },
    descriptionI18n: {
      'en-US':
        'Expert guide for installing, deploying, configuring, and troubleshooting Gods Eye. Proactively helps with setup, diagnoses issues, and provides security best practices.',
      'zh-CN': 'Gods Eye 安装、部署、配置和故障排查专家。主动协助设置、诊断问题并提供安全最佳实践。',
      'ru-RU':
        'Эксперт по установке, развёртыванию, настройке и устранению неполадок Gods Eye. Помогает пройти настройку, диагностирует проблемы и подсказывает безопасные практики.',
    },
    promptsI18n: {
      'en-US': [
        'Help me install Gods Eye step by step',
        "My Gods Eye isn't working, please diagnose the issue",
        'Configure Telegram channel for Gods Eye integration',
      ],
      'zh-CN': ['帮我一步步安装 Gods Eye', '我的 Gods Eye 出问题了，请帮我诊断', '为 Gods Eye 配置 Telegram 渠道'],
    },
  },
  {
    id: 'cowork',
