...
/**
 * Adapter class to convert ACP messages to Gods Eye message format
 */
export class AcpAdapter {
  ...
  /**
   * Convert ACP session update to Gods Eye messages
   */
  ...
  /**
   * Convert ACP session update chunk to Gods Eye message
   */
  ...
  /**
   * Convert ACP thought chunk to Gods Eye message
   */
  ...
  /**
   * Convert plan update to Gods Eye message
   */
