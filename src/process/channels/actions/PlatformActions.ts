  ...
  try {
    ...
    return createSuccessResponse({
      ...
      text: [
        '🔗 <b>Device Pairing</b>',
        '',
        'Please approve this pairing request in the Gods Eye app:',
        '',
        `<code>${code}</code>`,
        '',
  ...
  try {
    ...
    return createSuccessResponse({
      ...
      text: [
        ...
        `⏱ Valid for: ${expiresInMinutes} minutes`,
        '',
        'Please approve this pairing request in Gods Eye settings.',
      ].join('\n'),
      parseMode: 'HTML',
      replyMarkup: getPairingCodeMarkup(platform, code),
    });
  ...
  if (pendingRequest) {
    ...
    return createSuccessResponse({
      ...
      text: [
        ...
        '',
        'Please approve the pairing request in Gods Eye settings.',
      ].join('\n'),
      parseMode: 'HTML',
...
export const handlePairingHelp: ActionHandler = async (context) => {
  ...
  return createSuccessResponse({
    ...
    text: [
      ...
      '',
      '<b>What is pairing?</b>',
      `Pairing links your ${platformName} account with the local Gods Eye application.`,
