...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'Gods Eye Assistant',
    text: '### Gods Eye Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with Gods Eye:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open Gods Eye settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in Gods Eye settings:',
      '1. Open Gods Eye app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'Gods Eye Assistant Help',
    text: [
      '### Gods Eye Assistant Help',
      '',
      'A remote assistant to interact with Gods Eye via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in Gods Eye settings',
...
export function createSettingsCard(): DingTalkCard {
  return {
    ...
    text: [
      '### Settings',
      '',
      'Channel settings need to be configured in the Gods Eye app.',
      '',
      'Open Gods Eye > WebUI > Channels',
    ].join('\n'),
