...
4. PUT /v1.0/card/streaming            # Stream content (repeat)
   ...
   - isFull: true                      # Full replacement (Gods Eye sends complete content each time)
...
- **`isFull: true`** is always used because Gods Eye sends the complete message content on each edit (not incremental deltas)
