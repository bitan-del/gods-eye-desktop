...
export const PROTOCOL_SCHEME = 'godseye';

/**
 * Parse an godseye:// URL into action and params.
 * Supports two formats:
 *   1. godseye://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. godseye://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
