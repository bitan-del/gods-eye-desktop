...
export const CSRF_COOKIE_NAME = 'godseye-csrf-token';
 ...
 * 建议生产环境配置 HTTPS 并设置 GODSEYE_HTTPS=true
 * Recommend configuring HTTPS in production and setting GODSEYE_HTTPS=true
 */
export function getCookieOptions(): {
  ...
  const isHttps =
    process.env.GODSEYE_HTTPS === 'true' || (process.env.NODE_ENV === 'production' && process.env.HTTPS === 'true');
