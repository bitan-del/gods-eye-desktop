...
const EXTENSION_STATES_FILE_ENV = 'GODSEYE_EXTENSION_STATES_FILE';
 ...
 * Stored under getDataPath(): ~/.godseye/extension-states.json (Electron release),
 * ~/.godseye-dev/extension-states.json (Electron macOS dev), or the platform-standard
 * app data dir on Windows/Linux. Can be overridden via GODSEYE_EXTENSION_STATES_FILE.
 */
