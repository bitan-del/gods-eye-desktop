 ...
 * 2. Exposes a restricted `godseye` API proxy to the extension
 ...
 * - The `godseye` proxy provides a structured communication channel to the main thread
...
/**
 * The `godseye` object available to sandboxed extensions.
...
try {
  ...
  // Expose godseye proxy
  (globalThis as any).godseye = godseyeProxy;
