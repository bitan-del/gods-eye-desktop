...
/**
 * Backing storage service for the `godseye.storage` API exposed to sandboxed extensions.
 *
 * ## Context
 *
 * Worker 端扩展通过 `godseye.storage.get/set/delete` 发起 api-call 消息,
 ...
 *   ~/.godseye/extension-storage/{extensionName}.json
 *
