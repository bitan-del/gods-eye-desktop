...
export type ResolvedSettingsTab = {
  ...
  /** Display name */
  name: string;
  /** Icon URL (godseye-asset:// or undefined) */
  icon?: string;
  /** Content URL (godseye-asset:// local asset or external https:// URL) */
  entryUrl: string;
 ...
 * - local entryPoint: validate path + convert to godseye-asset:// URL
