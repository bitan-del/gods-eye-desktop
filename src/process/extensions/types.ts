...
export const RESERVED_NAME_PREFIXES = ['godseye-', 'internal-', 'builtin-', 'system-'];
...
export const ExtensionMetaSchema = z
  .object({
    ...
    /** P2: GODSEYE core version compatibility */
    engine: z
      .object({
        godseye: z
          .string()
          ...
          .optional()
          .describe('Compatible Gods Eye core version range'),
      })
      .optional(),
    /**
    ...
    permissions: z
      .object({
        /** Read/write to Gods Eye persistent storage */
