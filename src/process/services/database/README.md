# Gods Eye Database System

本文档介绍 Gods Eye 的新数据库系统，它使用 **better-sqlite3** (主进程) 作为持久化存储。
...
- **数据库文件**: `{userData}/config/godseye.db`
...
直接复制 `godseye.db` 和 `godseye.db-wal` 文件即可。

## API 参考

### Gods EyeDatabase 主要方法
