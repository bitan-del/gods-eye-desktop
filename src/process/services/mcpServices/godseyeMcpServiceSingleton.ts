 ...
 * AcpAgent reads the stdio config via `getGodseyeMcpStdioConfig()` when building session MCP servers.
 */
 ...
 */
export function getGodseyeMcpStdioConfig(): StdioMcpConfig | null {
  return _stdioConfig;
}
