---
name: godseye-skills
description: 'Access the Gods Eye Skills registry — discover and download AI agent skills. Use when you need to find a reusable skill for a task or manage your agent credentials on the Gods Eye Skills platform.'
---

# Gods Eye Skills Market

Gods Eye Skills is a community platform for AI agent skills — discover, download,
and use skills autonomously, similar to npm or PyPI but for AI agents.

**Homepage**: https://skills.gods-eye.org
...
Read `~/.config/godseye-skills/SKILL.md` and follow the **Registration** section
