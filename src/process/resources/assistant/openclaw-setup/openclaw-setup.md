...
**Option B: Start Gods Eye WebUI Remote Mode**

- **Experience**: Access through browser with Gods Eye's full interface features
...
- **Configuration requirements**: Start Gods Eye WebUI service, access through browser
...
5. **Post-installation configuration guidance** (IMPORTANT):
   ...
   - **Usage guidance**:
     - **Local usage**: "After OpenClaw installation is complete, **please restart Gods Eye**, then you can see OpenClaw in the available Agent list on the Gods Eye homepage and start chatting directly."
...
1. **Ask user preference first**: Ask user which method they want to configure → **Wait for user reply**
   - "Do you want to connect directly to IM channels (like Telegram, WhatsApp, etc.), or use Gods Eye WebUI remote mode?"
...
4. **Option B: Start Gods Eye WebUI Remote Mode**
   - **Must use godseye-webui-setup skill**: Consult `references/godseye-webui.md`
   - **Workflow**:
     1. Ask user needs: Same WiFi, cross-network access, or server deployment? → **Wait for user reply**
     2. After user replies, **guide user to Gods Eye settings interface**:
        - **Open settings interface**: Clearly tell user how to open it
          - "Please click the **Settings icon** (gear icon) at the bottom left of Gods Eye"
          - "In the settings menu, click the **'WebUI'** option"
          - "Enter the WebUI configuration interface"
        - **Configuration steps**: Follow `godseye-webui-setup` skill's `references/godseye-webui.md` documentation to guide user:
   ...
   - **Key principles**:
     ...
     - **Don't attempt to install `@godseye/webui` or similar npm packages**: WebUI is a built-in feature of Gods Eye, not a separate package
...
### godseye-webui-setup Skill

**Core documentation**: `references/godseye-webui.md`

**When to use**: When user chooses WebUI option, use immediately

**How to use**:

1. **Directly consult `references/godseye-webui.md`** and guide user to complete configuration following the documentation
...
5. **Post-installation configuration guidance**:
   ...
   - **Usage guidance**:
     - Introduce local usage (return to Gods Eye homepage)
...
3. **Choose WebUI**: Use `godseye-webui-setup` skill → Ask needs → Choose solution → Execute configuration → Provide usage instructions
...
7. **Skill usage**:
   ...
   - WebUI configuration → **Must use `godseye-webui-setup` skill** (directly consult `references/godseye-webui.md` and follow documentation, don't repeat detailed steps from documentation)
