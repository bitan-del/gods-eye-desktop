...
export const BUILTIN_IMAGE_GEN_NAME = 'godseye-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['Gods Eye Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
